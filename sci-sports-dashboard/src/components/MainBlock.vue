...
export default {
  ...
  setup() {
    ...
    console.log(store.playersList)

    const state = reactive({
      searchTerm: '',
      filteredPlayers: computed(() =>
        store.playersList.filter((player) =>
          player.name.includes(state.searchTerm)
        )
      ),
      positions: computed(() =>
        store.playersList.map((player) => player.position)
      ),
      ages: computed(() => store.playersList.map((player) => player.age)),
      nationality: computed(() =>
        store.playersList.map((player) => player.nationality)
      )
    })
    ...
    -->
      ...
      -->
        ...
        -->
          ...
          <div class="flex-shrink-0 flex items-center px-4">SCI SPORTS</div>
          <div class="mt-5 flex-1 h-0 overflow-y-auto">
            <nav class="px-2">
              <div class="space-y-1">
                ...
                <a
                  href="#"
                  class="text-gray-400 hover:text-gray-200 hover:bg-gray-50 group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md"
                >
              ...
              <span class="flex w-full justify-between items-center">
                ...
                >
                  <img
                    ...
                    src="https://avatars.githubusercontent.com/u/14905547?v=4"
                    alt=""
                  />
        ...
        <nav class="px-3 mt-6">
          <div class="space-y-1">
            ...
            <a
              href="#"
              disabled
              class="text-gray-300 hover:text-gray-200 hover:bg-gray-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md"
            >
              <!-- Heroicon name: outline/view-list -->
              <svg
                class="text-gray-400 group-hover:text-gray-500 mr-3 flex-shrink-0 h-6 w-6"
    ...
    <div class="lg:pl-64 flex flex-col">
      ...
      >
        ...
        <div class="flex-1 flex justify-between px-4 sm:px-6 lg:px-8">
          <div class="flex-1 flex">
            <ComboBox title="position" :options="positions" />
      ...
      <main class="flex-1">
        ...
        <div class="flex vertical-align">
          <ComboBox title="position" :options="positions" />
          <ComboBox title="age" :options="ages" />
          <ComboBox title="nationality" :options="nationality" />
        </div>
        <!-- Sidebar Search -->
        <div class="px-3 mt-5">
          ...
          >
            <table class="min-w-full">
              ...
              <tbody class="bg-white divide-y divide-gray-100">
                <tr v-for="(player, i) in filteredPlayers" :key="`player-${i}`">
                  ...
                  >
                    <div class="flex items-center space-x-3 lg:pl-2">
                      <a href="#" class="truncate hover:text-gray-600 inline">
                        <span>
                          {{ player.name }}
                        </span>
                      </a>
